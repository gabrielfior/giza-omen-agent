...
let node_11 = NNTrait::gemm(node__relu_1_relu_output_0, get_node_fc3_weight(), Option::Some(get_node_fc3_bias()), Option::Some(FP16x16 { mag: 65536, sign: false }), Option::Some(FP16x16 { mag: 65536, sign: false }), false, true);
